...
public class MensagensTransacao {
    ...
    public static final String MENSAGEM_ERRO_VALOR_NAO_POSITIVO = "Valor da transação deve ser positivo.";
    public static final String MENSAGEM_ERRO_CASAS_DECIMAIS = "Valor da transação deve ter no máximo 2 casas decimais.";
    public static final String MENSAGEM_ERRO_SALDO_INSUFICIENTE = "Saldo insuficiente. Saldo atual R$%.2f.";
    ...
    public static final String MENSAGEM_ERRO_LIMITE_CONTATO = "Limite de contato insuficiente. Limite atual para contato R$%.2f.";
